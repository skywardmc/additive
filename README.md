...
If you would like to install the modpack, go to this page on [the SkywardMC website](https://skywardmc.org/additive/installation). You can install the modpack with a third party launcher or our standalone installer. After you install, you can figure out how to tweak things to give greater optimizations in the [post-install](https://skywardmc.org/additive/post-install) section of the wiki. This includes procedures such as increasing your allocated memory and tweaking your game settings for your device.
...
For the list of performance mods that are included, see this [wiki page](https://skywardmc.org/adrenaline/performance-features).
...
- OptiFine donator capes (and [free capes](https://skywardmc.org/additive/supporter-cape))
- [All OptiFine features and more information on the wiki](https://skywardmc.org/additive/optifine-features)
...
- [All other features and more information on the wiki](https://skywardmc.org/additive/extra-features)
...
For a full list of currently supported features, see this [wiki page](https://skywardmc.org/additive/optifine-features).
...
Experiencing bugs, crashes, or other issues? Feel free to open an issue on the [issue tracker](https://github.com/skywardmc/Additive/issues). Be sure to include necessary information like your hardware/software (e.g. GPU and CPU, modpack version and OS) so that it's easier for us to find issues and resolve them.

# ❓ Frequently Asked Questions

For a few frequently asked questions, along with tons of other information, consider visiting the [wiki](https://skywardmc.org/additive). It has a few other helpful resources that I suggest you read, such as troubleshooting info and more. This wiki is often updated with new information.
